...
DATABASES = {
    'default': {
        ...
        'USER':     'postgres',                       # 'postgres'Not used with sqlite3.
        'PASSWORD': 'admin',                       # 'admin'Not used with sqlite3.
        'HOST':     'localhost',                  # 'localhost'Set to empty string for localhost. Not used with sqlite3.
        'PORT':     '5432',                       # '5432'Set to empty string for default. Not used with sqlite3.
    }
}
...
ROOT_URLCONF = 'DICSD.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'DICSD.wsgi.application'
